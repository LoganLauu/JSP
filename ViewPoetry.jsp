...
PreparedStatement search = conn.prepareStatement("select * from books where lower(book_cat)='poetry'");
...
if(searchResult.next()){
	...
	out.println("<html> <style>table, th, td {border:1px solid black;}</style><body><center><h2>Poetry Books</center></h2>");
	out.println("<hr><br>");
